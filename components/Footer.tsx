              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-10 h-10 bg-gray-900 rounded-lg flex items-center justify-center text-gray-300 hover:text-white hover:bg-gray-800 transition-all duration-200"
